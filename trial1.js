document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("glowing-candle").addEventListener("click", function () {
        document.getElementById("failure-popup").classList.remove("hidden");
        document.getElementById("failure-popup").style.display = "block"; 
    });

   
    document.getElementById("unlit-candle").addEventListener("click", function () {
...
function startCountdown() {
    ...
    console.log("Game session should start now!");
}
